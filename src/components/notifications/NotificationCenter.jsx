...
export default function NotificationCenter() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          {unreadCount > 0 && (
            <span
              ...
              style={{ background: '#e8356d', color: '#fff' }}
            >
              {unreadCount}
            </span>
          )}
      ...
      <DialogContent style={{ background: '#13132a', border: '1px solid rgba(232,53,109,0.3)' }} className="max-w-md">
        <DialogHeader>
          ...
          {isLoading ? (
            ...
            notifications.map((notification) => (
              <div
                ...
                style={{
                  background: notification.is_read ? 'rgba(255,255,255,0.03)' : 'rgba(232,53,109,0.1)',
                  borderColor: notification.is_read ? 'rgba(255,255,255,0.08)' : 'rgba(232,53,109,0.25)'
                }}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    {!notification.is_read && (
                      ...
                      >
                        <Check className="w-3 h-3" style={{ color: '#e8356d' }} />
                      </Button>
                    )}
                    <Button
                      size="icon"
