...
export default function SearchBar({ onSearch, initialQuery = '', initialLocation = '', dark = false }) {
  ...
  if (dark) {
    return (
      <form onSubmit={handleSubmit} className="w-full">
        <div className="flex flex-col md:flex-row gap-2 p-2 rounded-2xl" style={{ background: '#13132a', border: '1px solid rgba(232,53,109,0.3)' }}>
          ...
          <div className="relative md:w-56 flex gap-2">
            ...
            <button
              ...
              style={{ background: 'rgba(232,53,109,0.15)', border: '1px solid rgba(232,53,109,0.3)', color: PINK }}
            >
          ...
          <Button
            type="submit"
            className="h-12 px-8 text-white rounded-xl border-0"
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <div className="flex flex-col md:flex-row gap-3 p-2 bg-white rounded-2xl shadow-lg border border-slate-100">
        <div className="flex-1 relative">
        ...
        <div className="relative md:w-64 flex gap-2">
          <div className="relative flex-1">
        ...
        <Button
          type="submit"
          className="h-12 px-8 rounded-xl text-white border-0"
          style={{ background: PINK }}
        >
          Search
        </Button>
