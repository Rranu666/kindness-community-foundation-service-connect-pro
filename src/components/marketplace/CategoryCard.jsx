...
export default function CategoryCard({ category, providerCount = 0 }) {
  ...
  return (
    <Link 
      ...
      onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(203,60,122,0.4)'; e.currentTarget.style.background = 'rgba(203,60,122,0.06)'; }}
    ...
    >
      ...
      <div className="relative">
        ...
        <span className="text-xs font-medium" style={{ color: '#cb3c7a' }}>{providerCount} providers</span>
      </div>
    </Link>
  );
}