...
export default function CategoryCard({ category, providerCount = 0 }) {
  ...
  return (
    <Link 
      ...
      onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(232,53,109,0.4)'; e.currentTarget.style.background = 'rgba(232,53,109,0.06)'; }}
    ...
    >
      ...
      <div className="relative">
        ...
        <span className="text-xs font-medium" style={{ color: '#e8356d' }}>{providerCount} providers</span>
      </div>
    </Link>
  );
}