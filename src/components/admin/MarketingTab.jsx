...
function BannersSection() {
  const blankBanner = { title: '', subtitle: '', cta_text: 'Book Now', cta_url: '/', image_url: '', bg_color: '#e8356d', position: 'home_top', is_active: true };
  const [banners, setBanners] = useState([
    { id: 1, title: '20% Off This Weekend', subtitle: 'On all cleaning services', cta_text: 'Book Now', cta_url: '/', image_url: '', bg_color: '#e8356d', position: 'home_top', is_active: true },
