  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent
        ...
        style={{ background: '#13132a', border: '1px solid rgba(232,53,109,0.3)', borderRadius: 20 }}
      >
          ...
          {!isRoleStep ? (
            ...
            <div className="text-center">
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(232,53,109,0.12)', border: '1px solid rgba(232,53,109,0.2)' }}>
                  {currentStep.icon}
                </div>
              </div>
              ...
              {currentStep.highlight && (
                <div className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs font-semibold" style={{ background: 'rgba(232,53,109,0.1)', border: '1px solid rgba(232,53,109,0.25)', color: PINK }}>
            ...
            <div>
              ...
              <div className="space-y-3 mb-6">
                <button
                  ...
                  style={{
                    background: selectedRole === 'customer' ? 'rgba(232,53,109,0.15)' : 'rgba(255,255,255,0.04)',
                    border: `2px solid ${selectedRole === 'customer' ? PINK : 'rgba(255,255,255,0.1)'}`,
                  }}
                  onClick={() => setSelectedRole('customer')}
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl" style={{ background: 'rgba(232,53,109,0.15)' }}>
                      🔍
                    </div>
                    <div>
                ...
                <button
                  className="w-full rounded-2xl p-4 text-left transition-all"
                  style={{
                    background: selectedRole === 'provider' ? 'rgba(232,53,109,0.15)' : 'rgba(255,255,255,0.04)',
